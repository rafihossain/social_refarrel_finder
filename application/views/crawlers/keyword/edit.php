...
<header class="top-header">
   ...
   <div class="header-page">
      <h4 class="heading-title">Edit Keyword</h4>
   </div>
</header>
...
<main class="page-content">
  <div class="card">
    <div class="card-body">
      ...
      <form method="post" action="<?php echo base_url(); ?>crawler_update_keyword/<?php echo $keyword->id; ?>">
        ...
        <div class="col-12 mb-3">
          ...
          <select name="must_include_condition" class="form-control">
            ...
            <option value="one" <?php echo ($keyword->must_include_condition == 'one' ? 'selected' : '');  ?> selected>At least one keyword</option>
          </select>
        </div>
        <div class="col-12 mb-3">
        ...
        <div class="d-flex mt-4">
          <a class="btn btn-outline-danger btn-rounded" href="<?php echo base_url() ?>crawler_keyword">Cancel</a>
