  ...
  <div class="row">
    <div class="col-md-7">
      <div class="card">
        <div class="card-body">
          <h2>Keywords</h2>
          <p>Add some keywords for <?php if(isset($cinfo->end_client)){ echo $cinfo->end_client; } ?> client</p>
          ...
          <form id="newkeyword" method="post" action="<?php echo base_url(); ?>ambass_add_key">
    ...
    <div class="col-md-5">
      <div class="card" style="min-height:160px">
        <div class="card-body text-center" id="for_flex">
          ...
          <form method="post" action="<?= base_url() ?>ambasscsv_keyword" enctype="multipart/form-data">
            ...
            <tr>
              ...
              <td class="text-wrap">
                <div class="table-actions d-flex align-items-center gap-3 fs-6">
                  ...
                  <a class="btn btn-primary" href="<?php echo base_url() ?>ambass_edit_key/<?php echo $keyword->id; ?>" class="text-danger" title="Edit"><i class="bi bi-pencil"></i></a>


                  <a class="btn btn-danger" id="deleteKeyWord" data-id="<?php echo $keyword->id; ?>" class="text-danger" title="Delete"><i class="bi bi-trash-fill"></i>
                  </a>
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            $.ajax({
              url: "<?php echo base_url() ?>ambass_delete_key/" + Id,
              dataType: "JSON",
              success: function(data) {
                window.location.reload();
              }
