...
<main class="page-content">
  <div class="card">
    <div class="card-body">
      ...
      <form method="post" action="<?php echo base_url(); ?>ambass_update_key/<?php echo $keyword->id; ?>">
        ...
        <a class="btn btn-outline-danger btn-rounded" href="<?php echo base_url() ?>ambass_key_view">Cancel</a>
