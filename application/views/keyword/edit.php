...
<main class="page-content">
  <div class="card">
    <div class="card-body">
      ...
      <form method="post" action="<?php echo base_url(); ?>updateclientkeyword/<?php echo $keyword->id; ?>">
        ...
        <div class="d-flex mt-4">
          <a class="btn btn-outline-danger btn-rounded" href="<?php echo base_url() ?>clientkeyword">Cancel</a>
