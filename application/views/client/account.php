      ...
      <div class="row heading-content">
         <div class="col-md-8">
            <div class="row">
               <div class="col-md-4">
                  <span>Name</span>
                  <h4><?= $clientinfo->full_name; ?></h4>
               </div>
               <div class="col-md-4">
                  <span>Email</span>
                  <h4><?= $clientinfo->email; ?></h4>
               </div>
               <!-- <div class="col-md-4">
                  <span>Phone</span>
         ...
         <div class="col-md-4 text-end">
            <i class="bi bi-pencil-square editProfileICon"></i>
         </div>
      </div>
   </div>
</header>
         ...
         <div class="card">
            <div class="card-body">
               <div class="facebook-group">
                  ...
                  <form method="post" action="<?php echo base_url(); ?>clientaccount">
                     <div class="row">
                  ...
                  <form method="post" action="<?php echo base_url(); ?>client_profile">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-12 mb-2">
                        ...
                        <input type="hidden" class="form-control" name="profile_id" value="<?= $clientinfo->id; ?>">
                        <input type="text" class="form-control" name="profile_name" value="<?= $clientinfo->full_name; ?>">
                     </div>
                     <div class="col-md-12 mb-2">
                        <label for="">Email</label>
                        <input type="text" class="form-control" name="profile_email" value="<?= $clientinfo->email; ?>">
                     </div>
                     <div class="col-md-12 mb-2">
