                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-6 bg-primary d-flex align-items-center justify-content-center">
                                <div class="card-body p-4 p-sm-5">
                                    ...
                                    <form class="form-body" method="post" action="<?= base_url(); ?>reset_pass/<?= $token; ?>">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    <div class="ms-auto position-relative">
                                                        ...
                                                        <input type="password" class="form-control rounded-0 ps-5 border-0  " id="inputChoosePassword" name="password" placeholder="ENTER PASSWORD" value="">
                                                    </div>
                                                </div>
                                                <div class="mt-2 text-neutral"><?php echo form_error('password'); ?></div>

                                                <div class="col-12">
                                                    <div class="ms-auto position-relative">
                                                        <div class="position-absolute top-50 translate-middle-y search-icon px-3"><i class="bi bi-lock-fill text-primary"></i></div>
                                                        <input type="password" class="form-control rounded-0 ps-5 border-0  " id="inputChoosePassword" name="confirm_pass" placeholder="ENTER CONFIRM PASSWORD" value="">
                                                    </div>
                                                </div>
                                                <div class="mt-2 text-neutral"><?php echo form_error('confirm_pass'); ?></div>
                                        ...
                                        <?php if (isset($success)) : ?>
                                            <div class="row g-3">
                                                <div class="col-12 mb-4">
                                                    <div class="d-grid">
                                                        <a href="<?php echo base_url(); ?>" type="submit" class="btn btn-neutral rounded-0 text-uppercase">Login</a>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php endif; ?>
